<?php
    ...
    if (isset($_POST["verify_email"]))
    {
        ...
        $sql = "UPDATE admin SET email_verified_at = NOW() WHERE email ='$email' AND verification_code = '$verification_code'";
       ...
       // echo "<p>You can login now.</p>";
        header('location:teacherslogin.php?registered');
        exit();
    }
...
<head>
    ...
    <link rel="stylesheet" href="teacheslogin.css">
