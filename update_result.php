...
$sql= "UPDATE result SET subject_1 = '$subject_1', subject_2='$subject_2',subject_3='$subject_3',subject_4='$subject_4',subject_5='$subject_5' WHERE series=$series AND id=$id";
$con->query($sql);
//for($i=1;$i<=5;$i++){
if($subject_1>=80){
    $s_gpa_1=4.00;
...
if($subject_5<80 && $subject_5>=75){
    $s_gpa_5=3.75;
    $sql1= "INSERT into result SET subject_gpa_5= 3.75 WHERE id= $id AND series=$series    ";
    $con->query($sql1);
}
...
header('location:update_result.php?udated');
}
...
<body>
    ...
    <section class="headerr">
        <div class="signup_form">
            ...
            <?php
        if(isset($_GET['udated'])){
            echo "<h4 style='color:greenyellow;text-align: center;margin: 0;font-size: 16px;padding: 0;font-weight: bold;'>Result have succesfully updated!!!</h4>";
        }
        ?>
            <h1>Update Result</h1>
